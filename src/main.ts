...
`;
	...
	private _showBadge(header: HTMLElement) {
		...
		const count = this._getGroupCount(groupValue);
	...
	private _updateBadgeQuick(header: HTMLElement) {
		// Update only the badge text if it exists, don't create new badges
